...
public abstract interface AuthService {
    ...
    kotlin.coroutines.Continuation<? super work.sample.data.models.auth.signin.SignInResponse> continuation);
    ...
    kotlin.coroutines.Continuation<? super work.sample.data.models.auth.signup.SignUpResponse> continuation);
}