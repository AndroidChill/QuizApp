...
public final class FragmentIntroBinding implements ViewBinding {
  ...
  private FragmentIntroBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialButton btnStarted, @NonNull ImageView imageView,
  ...
  public static FragmentIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btn_started;
      MaterialButton btnStarted = ViewBindings.findChildViewById(rootView, id);
      if (btnStarted == null) {
        break missingId;
      }
      ...
      return new FragmentIntroBinding((ConstraintLayout) rootView, btnStarted, imageView,
          textView3);
    }
